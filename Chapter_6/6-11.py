...
# имеет два поля: имя студента и баллы студента за итоговый экзамен. Напишите программу,
# которая меняет балльную оценку Джулии Милан на 100.
...
def main():
    try: 
        ...
        if found:
            ...
            print('Такой студент отсутствует, либо скорринговое значение уже соответствует целевому.')
            print('Файл перезаписан, но не обновлён.')
